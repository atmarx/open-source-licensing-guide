...
Start with the concepts. I know you want to skip ahead to "which license should I pick," but trust me—five minutes understanding the foundations will save you hours of confusion later.
...
-   :material-lightbulb-outline:{ .lg .middle } **Concepts**
    ...
    [:octicons-arrow-right-24: Learn the basics](concepts/index.md)

-   :material-scale-balance:{ .lg .middle } **Software Licenses**
    ...
    [:octicons-arrow-right-24: Explore licenses](licenses/index.md)

-   :material-creative-commons:{ .lg .middle } **Creative Commons**

    ---

    Licenses for everything that isn't code: documentation, datasets, images, research. Different tools for different work.

    [:octicons-arrow-right-24: Creative Commons](creative-commons/index.md)

-   :material-compass-outline:{ .lg .middle } **Practical Guides**

    ---

    The "how do I actually do this" section: choosing a license, complying with licenses, and getting attribution right.

    [:octicons-arrow-right-24: Get practical](guides/choosing-a-license.md)

-   :material-fire:{ .lg .middle } **Lessons Learned**

    ---

    The cautionary tales. Real incidents where licensing went wrong, and what we can learn from the fallout.

    [:octicons-arrow-right-24: Learn from history](lessons-learned/index.md)

</div>

## Quick Reference

In a hurry? The [quick comparison table](reference/quick-comparison.md) gives you the essentials at a glance.

Confused by a term? Check the [glossary](reference/glossary.md), or just hover over highlighted terms—they'll explain themselves.

---

!!! tip "The obligatory disclaimer"
    I'm a developer, not a lawyer. This guide reflects decades of practical experience, but it's not legal advice. For specific legal questions about your situation, talk to an actual attorney. They're not as scary as you think, and they've saved more than a few projects I've worked on.
